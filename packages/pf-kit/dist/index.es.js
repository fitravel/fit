...
import { defineComponent, openBlock, createElementBlock, normalizeClass, createElementVNode, getCurrentInstance, inject, markRaw, ref, watch, reactive, effectScope, isRef, isReactive, toRaw, onUnmounted, nextTick, toRefs, computed, getCurrentScope, onScopeDispose, unref, shallowRef, createTextVNode, toDisplayString, renderSlot, createCommentVNode, Fragment, renderList, normalizeProps, guardReactiveProps, createBlock, withCtx, createVNode, mergeProps } from "vue";
  ...
  setup(__props) {
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        class: normalizeClass(["pf-alert", { type: __props.type }])
      }, [
        createElementVNode("div", { innerHTML: __props.message }, null, 8, _hoisted_1$2),
...
var bind$2 = /* @__PURE__ */ _curry2(function bind(fn, thisObj) {
...
function money(n, {
  ...
  if (!isFinite(f) || !f && f !== 0) {
    ...
    const $000cc = replace$2(".", decimalSeparator, Math.abs(f).toFixed(decimals));
    const $000__ = decimals ? slice$2(0, d, $000cc) : $000cc;
    const ____cc = decimals ? slice$2(d, Infinity, $000cc) : "";
    const x000__ = $000__.length % 3;
    const $_____ = x000__ > 0 ? slice$2(0, x000__, $000__) + ($000__.length > 3 ? thousandsSeparator : "") : "";
    const _000__ = replace$2(r, `$1${thousandsSeparator}`, slice$2(x000__, Infinity, $000__));
    return `${A}${$_____}${_000__}${____cc}${Z}`;
  }
}
function isk(n, decimals = 0) {
  const symbol = "kr.";
...
function vanityPrice(amount) {
  ...
  const calc = (n) => {
    const reduced = Math.round(parseInt(n) / roundTo);
    const string = toString$1(reduced);
    const digit = parseInt(slice$2(-1, Infinity, string));
...
const byId = curry$1((id, i) => +(i == null ? void 0 : i.id) === id);
const bySlug = curry$1((slug, i) => `${i == null ? void 0 : i.slug}` === slug);
...
var objectInspect = function inspect_(obj, options, depth, seen) {
  ...
  if (typeof obj === "function") {
    var name = nameOf(obj);
    var keys4 = arrObjKeys(obj, inspect2);
...
var sentinel = {};
var stringify$1 = function stringify(object, prefix, generateArrayPrefix, strictNullHandling, skipNulls, encoder, filter2, sort3, allowDots, serializeDate2, format2, formatter, encodeValuesOnly, charset, sideChannel2) {
  var obj = object;
  ...
  for (var j = 0; j < objKeys.length; ++j) {
    ...
    pushToArray(values, stringify(value, keyPrefix, generateArrayPrefix, strictNullHandling, skipNulls, encoder, filter2, sort3, allowDots, serializeDate2, format2, formatter, encodeValuesOnly, charset, valueSideChannel));
  }
  return values;
};
...
var stringify_1 = function(object, opts) {
  ...
  for (var i = 0; i < objKeys.length; ++i) {
    ...
    pushToArray(keys4, stringify$1(obj[key], key, generateArrayPrefix, options.strictNullHandling, options.skipNulls, options.encode ? options.encoder : null, options.filter, options.sort, options.allowDots, options.serializeDate, options.format, options.formatter, options.encodeValuesOnly, options.charset, sideChannel2));
  }
...
function createSetupStore($id, setup, options = {}, pinia, hot) {
  ...
  for (const key in setupStore) {
    const prop3 = setupStore[key];
    if (isRef(prop3) && !isComputed(prop3) || isReactive(prop3)) {
      if (!buildState) {
        if (initialState && shouldHydrate(prop3)) {
          if (isRef(prop3)) {
            prop3.value = initialState[key];
          } else {
            mergeReactiveObjects(prop3, initialState[key]);
          }
        }
        {
          pinia.state.value[$id][key] = prop3;
        }
      }
    } else if (typeof prop3 === "function") {
      const actionValue = wrapAction(key, prop3);
      {
        setupStore[key] = actionValue;
      }
      optionsForPlugin.actions[key] = prop3;
    } else
      ;
  }
  {
...
function fetchEndpoint$1(endpoint, query) {
  return fetch(`${config.baseURL}/${endpoint}?${lib.stringify(__spreadValues({ per_page: 100 }, query))}`).then((i) => i.json());
}
const basicGetter = (fn) => {
  return (state) => (x) => {
    var _a2;
    return (_a2 = find$1(fn(x))(state.items)) != null ? _a2 : null;
  };
};
function initState(id, model2, query = {}, _extensions = {}) {
  const extensions = __spreadValues({
    state: {},
    getters: {},
    actions: {}
  }, _extensions);
  return defineStore(`gygax-${id}`, {
    ...
    getters: __spreadValues({
      byId: basicGetter(byId),
      bySlug: basicGetter(bySlug)
    }, extensions.getters),
    actions: __spreadValues({
      async init() {
        const load = await fetchEndpoint$1(id, query);
        this.items = map$1(model2)(load);
        this.isReady = true;
      }
    }, extensions.actions)
  });
}
function parseOffer(i) {
  var _a2, _b2, _c, _d, _e, _f, _g, _h, _i, _j, _k, _l, _m, _n, _o, _p, _q, _r, _s;
  const o3 = lib.parse(split$2("?")(i.url)[1]);
  const query = {
    oid: i.owner,
    from: o3.from,
    to: o3.to,
    outbound: isNil$1(o3 == null ? void 0 : o3.out) ? void 0 : +o3.out,
    inbound: isNil$1(o3 == null ? void 0 : o3.in) ? void 0 : +o3.in,
    adults: +((_b2 = (_a2 = o3 == null ? void 0 : o3.adults) != null ? _a2 : o3 == null ? void 0 : o3.adt) != null ? _b2 : 1),
    children: +((_d = (_c = o3 == null ? void 0 : o3.children) != null ? _c : o3 == null ? void 0 : o3.chd) != null ? _d : 0),
    infants: +((_f = (_e = o3 == null ? void 0 : o3.infants) != null ? _e : o3 == null ? void 0 : o3.inf) != null ? _f : 0),
    destination: +((_h = (_g = o3 == null ? void 0 : o3.destination) != null ? _g : o3 == null ? void 0 : o3.dest) != null ? _h : 0),
    origin: isNil$1((_i = o3 == null ? void 0 : o3.departing) != null ? _i : o3 == null ? void 0 : o3.dep) ? void 0 : +((_k = (_j = o3 == null ? void 0 : o3.departing) != null ? _j : o3 == null ? void 0 : o3.dep) != null ? _k : 0),
    hotel: +((_n = (_m = (_l = o3 == null ? void 0 : o3.hotel) != null ? _l : o3 == null ? void 0 : o3.hid) != null ? _m : o3 == null ? void 0 : o3.id) != null ? _n : 0),
    room: +((_p = (_o = o3 == null ? void 0 : o3.room) != null ? _o : o3 == null ? void 0 : o3.rid) != null ? _p : 0),
    mealplan: +((_s = (_r = (_q = o3 == null ? void 0 : o3.mealplan) != null ? _q : o3 == null ? void 0 : o3.mid) != null ? _r : o3 == null ? void 0 : o3.mp) != null ? _s : 0)
  };
  return __spreadProps(__spreadValues({}, i), { query });
}
function model$2(i) {
  var _a2, _b2, _c;
  const { id, slug, acf } = i;
  const title = (_b2 = (_a2 = i == null ? void 0 : i.title) == null ? void 0 : _a2.rendered) != null ? _b2 : "";
  const offers = map$1(parseOffer)((_c = acf == null ? void 0 : acf.offers) != null ? _c : []);
  return { id, slug, title, offers };
}
initState("offeramas", model$2, { sites: 244 }, {
  getters: {
    offers: (state) => compose(flatten$1, map$1((i) => i.offers))(state.items)
  }
});
const model$1 = ({ id, slug, name, description, parent, acf }) => ({
  id,
  slug,
  name,
  parent,
...
const useOwners = initState("owners", model$1);
const config = {
  baseURL: "https://gygax.fitravel.info/wp-json/wp/v2"
};
async function fetchEndpoint(oid, type3, actions, query) {
  var _a2;
  const { token: token2 = "" } = (_a2 = useOwners().byId(oid)) != null ? _a2 : {};
  const segments = Array.isArray(actions) ? join$1("/")(actions) : actions;
  const url2 = `${config$1.baseURL}/${type3}/${token2}/is-IS/${segments}?${lib.stringify(query)}`;
  return fetch(url2).then((i) => i.json());
}
function flightPrice(flight, { isBase = true, isTax = true, isFlightOnly = false, isOneWay = false } = {}) {
  const price = (key, flag = true) => {
    var _a2, _b2;
    return flag ? +((_b2 = (_a2 = flight.prices) == null ? void 0 : _a2[key]) != null ? _b2 : 0) : 0;
  };
  return sum$1([
    price("base", isBase),
...
const model = (i) => i;
const useFlightAvailability = defineStore({
  id: "odin-flight-offers",
  state: () => ({
    hashes: [],
    supply: []
  }),
  actions: {
    createHash(query) {
      ...
      return compose(join$1("+"), map$1(join$1(":")), sort$1((a, b) => a[0].localeCompare(b[0])), toPairs$1)(pick$1(props)(query));
    },
    async check(query) {
      var _a2, _b2;
      const hash = this.createHash(query);
      if (!includes$1(hash)(this.hashes))
        this.fetch(query, hash);
      return (_b2 = (_a2 = find$1(propEq$1("hash")(hash))(this.supply)) == null ? void 0 : _a2.data) != null ? _b2 : null;
    },
    async fetch(query, _hash) {
      const hash = _hash != null ? _hash : this.createHash(query);
      this.hashes = append$1(hash)(this.hashes);
      ...
      const data = { outbound: map$1(model)(outbound), inbound: map$1(model)(inbound) };
      this.supply = append$1({ hash, data })(this.supply);
    }
  }
});
...
var __objRest$5 = (source, exclude) => {
  ...
  for (var prop3 in source)
    if (__hasOwnProp$a.call(source, prop3) && exclude.indexOf(prop3) < 0)
      target[prop3] = source[prop3];
  if (source != null && __getOwnPropSymbols$a)
    for (var prop3 of __getOwnPropSymbols$a(source)) {
      if (exclude.indexOf(prop3) < 0 && __propIsEnum$a.call(source, prop3))
        target[prop3] = source[prop3];
    }
  return target;
};
...
var __spreadValues$3 = (a, b) => {
  for (var prop3 in b || (b = {}))
    if (__hasOwnProp$3.call(b, prop3))
      __defNormalProp$3(a, prop3, b[prop3]);
  if (__getOwnPropSymbols$3)
    for (var prop3 of __getOwnPropSymbols$3(b)) {
      if (__propIsEnum$3.call(b, prop3))
        __defNormalProp$3(a, prop3, b[prop3]);
    }
  return a;
};
...
const findById = curry$1(function(id, fallback, supply) {
  var _a2, _b2;
  return (_b2 = (_a2 = find$1(propEq$1("id", id))(supply)) != null ? _a2 : fallback(supply)) != null ? _b2 : null;
});
function useFlightOffer(query) {
  const store = useFlightAvailability();
  const { state } = useAsyncState(() => store.check(query), { outbound: [], inbound: [] });
  const outbound = computed(() => {
    var _a2, _b2, _c;
    return findById((_a2 = query == null ? void 0 : query.outbound) != null ? _a2 : 0, head$1)((_c = (_b2 = state.value) == null ? void 0 : _b2.outbound) != null ? _c : []);
  });
  const inbound = computed(() => {
    var _a2, _b2, _c;
    return findById((_a2 = query == null ? void 0 : query.inbound) != null ? _a2 : 0, head$1)((_c = (_b2 = state.value) == null ? void 0 : _b2.inbound) != null ? _c : []);
  });
  const isOneWay = computed(() => !inbound.value);
  const price = computed(() => {
    var _a2, _b2;
    const total = !outbound.value ? 0 : sum$1([
      flightPrice(outbound.value, { isOneWay: isOneWay.value, isFlightOnly: true }),
      isOneWay.value ? 0 : flightPrice(inbound.value, { isFlightOnly: true }),
      900
    ]);
    const pax = ((_a2 = query == null ? void 0 : query.adults) != null ? _a2 : 1) + ((_b2 = query == null ? void 0 : query.children) != null ? _b2 : 0);
    const amount = Math.round(parseFloat(`${total / pax}`));
    return o$1(isk, vanityPrice)(amount);
  });
  const url2 = computed(() => {
    var _a2, _b2, _c, _d, _e, _f, _g, _h, _i;
    const params = {
      dep: (_a2 = query == null ? void 0 : query.origin) != null ? _a2 : 1,
      dest: (_b2 = query == null ? void 0 : query.destination) != null ? _b2 : 1,
      from: query.from,
      to: query.to,
      out: (_d = (_c = outbound.value) == null ? void 0 : _c.id) != null ? _d : 0,
      in: (_f = (_e = inbound.value) == null ? void 0 : _e.id) != null ? _f : 0,
      adt: (_g = query == null ? void 0 : query.adults) != null ? _g : 1,
      chd: (_h = query == null ? void 0 : query.children) != null ? _h : 0,
      inf: (_i = query == null ? void 0 : query.infants) != null ? _i : 0
    };
    return `https://plusferdir.is/boka/flugsaeti/?${lib.stringify(params)}`;
  });
  return { outbound, inbound, isOneWay, url: url2, price };
}
...
var formatDistance$2 = function(token2, count, options) {
  var result;
  var tokenValue = formatDistanceLocale$1[token2];
...
var formatRelative$2 = function(token2, _date, _baseDate, _options) {
  return formatRelativeLocale$1[token2];
};
...
const _hoisted_2$1 = { class: "flight-offer tw-border-b tw-border-black tw-py-4" };
const _hoisted_3$1 = { class: "row" };
const _hoisted_4$1 = { class: "col-sm-3 tw-grid tw-items-center md:tw-h-24 tw-text-center sm:tw-text-left" };
const _hoisted_5$1 = /* @__PURE__ */ createTextVNode(", ");
const _hoisted_6 = /* @__PURE__ */ createElementVNode("br", null, null, -1);
const _hoisted_7 = { key: 0 };
const _hoisted_8 = { key: 1 };
const _hoisted_9 = { class: "col-sm-3 tw-text-center tw-grid tw-items-center md:tw-h-24" };
const _hoisted_10 = { key: 0 };
const _hoisted_11 = { key: 1 };
const _hoisted_12 = { class: "col-sm-3 tw-grid tw-items-center md:tw-h-24" };
const _hoisted_13 = { class: "price tw-text-center sm:tw-text-right" };
const _hoisted_14 = /* @__PURE__ */ createTextVNode(" Ver\xF0 fr\xE1 ");
const _hoisted_15 = { class: "tw-text-3xl tw-font-black tw-italic" };
const _hoisted_16 = { class: "col-sm-3 tw-grid tw-items-center md:tw-h-24" };
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const props = __props;
    const { outbound, inbound, isOneWay, url: url2, price } = useFlightOffer(props.query);
    function fixAirport(s = "") {
      switch (s) {
        case "Alicante Airport":
          return "Alicante";
        case "Tenerife TFS":
          return "Tenerife";
        case "Las Palmas":
    ...
    function date(d) {
      console.log("d", d);
      return format(new Date(d), "do MMM", { locale: isLocale });
    }
    return (_ctx, _cache) => {
      var _a2, _b2, _c, _d, _e;
      return openBlock(), createElementBlock("a", { href: unref(url2) }, [
        createElementVNode("article", _hoisted_2$1, [
          createTextVNode(toDisplayString(unref(outbound)) + " ", 1),
          createElementVNode("div", _hoisted_3$1, [
            createElementVNode("div", _hoisted_4$1, [
              createElementVNode("div", null, [
                createElementVNode("strong", null, toDisplayString(fixAirport((_a2 = unref(outbound)) == null ? void 0 : _a2.airports.origin.name)), 1),
                createTextVNode(" " + toDisplayString(unref(isOneWay) ? "\u2192" : "\u2194") + " ", 1),
                createElementVNode("strong", null, toDisplayString(fixAirport((_b2 = unref(outbound)) == null ? void 0 : _b2.airports.destination.name)), 1),
                _hoisted_5$1,
                _hoisted_6,
                unref(isOneWay) ? (openBlock(), createElementBlock("span", _hoisted_7, "a\xF0ra lei\xF0")) : (openBlock(), createElementBlock("span", _hoisted_8, "b\xE1\xF0ar lei\xF0ir"))
              ])
            ]),
            createElementVNode("div", _hoisted_9, [
              unref(isOneWay) ? (openBlock(), createElementBlock("div", _hoisted_10, toDisplayString(date((_c = unref(outbound)) == null ? void 0 : _c.from)), 1)) : (openBlock(), createElementBlock("div", _hoisted_11, toDisplayString(date((_d = unref(outbound)) == null ? void 0 : _d.from)) + " \u2013 " + toDisplayString((_e = unref(inbound)) == null ? void 0 : _e.from), 1))
            ]),
            createElementVNode("div", _hoisted_12, [
              createElementVNode("div", _hoisted_13, [
                _hoisted_14,
                createElementVNode("strong", _hoisted_15, toDisplayString(unref(price)), 1)
              ])
            ]),
            createElementVNode("div", _hoisted_16, [
              createElementVNode("a", {
                href: unref(url2),
                class: "black-button tw-mt-4 sm:tw-mt-0"
              }, " Sko\xF0a tilbo\xF0 ", 8, _hoisted_17)
            ])
          ])
        ])
      ], 8, _hoisted_1$1);
...
function useJanus(lockArg, urlArg) {
  ...
  const request = curry$1(async (method, payload) => {
    var _a2, _b2, _c;
    const config2 = { method, body: JSON.stringify(getProps(payload)) };
    const load = await fetch(endpoint, config2).then((i) => i.json());
    if (load.success) {
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  setup(__props) {
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(_sfc_main$1), { class: "" }, {
        header: withCtx(() => []),
        footer: withCtx(() => []),
        alert: withCtx((item) => [
          createVNode(_sfc_main$3, mergeProps(item, {
            onClose: item.close
          }), null, 16, ["onClose"])
        ]),
        hermes: withCtx(() => [
...
export { _sfc_main$3 as Alert, _sfc_main$2 as FlightOffer, _sfc_main as Page };
