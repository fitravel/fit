import { MaybeRef, UseFetchOptions } from "@vueuse/core";
declare type D = Record<string, any>;
export declare function useBruce(): {
    getSource: (slug: string) => any;
    fetchStats: (query: MaybeRef<D[] | D>, options?: UseFetchOptions | undefined) => {
        stats: import("vue").ComputedRef<any>;
        execute: () => void;
        isReady: import("vue").ComputedRef<any>;
