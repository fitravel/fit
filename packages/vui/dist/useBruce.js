import { get, useFetch, whenever } from "@vueuse/core";
...
export function useBruce() {
    const getSource = (slug) => find((i) => i?.slug === slug)(bruce.data.value) ?? null;
    const fetchStats = (query, options) => {
...
//# sourceMappingURL=useBruce.js.map